    ...
    <div class="row no-gutters">
        ...
        <div class="col-12 col-sm-6 col-md-6 col-lg-3">
            <div class="input-group date-range">
                <input class="form-control from" type="text" id="header-fromdate" value="" placeholder="From" name="date_start">
                <input class="form-control to" type="text" id="header-todate" value="" placeholder="To" name="date_end">
            </div>
        </div>
        <div class="col-12 col-sm-6 col-md-6 col-lg-2">
            <select class="form-control bedrooms" name="bedrooms" id="bedrooms">
                ...
                ?>
                <option <?php echo $bedrooms == $bedroomNumber ? "selected": ""; ?> value=""><?php echo $bedroomNumber; ?>+</option>
                <?php 
                }
                ?>
            </select>
