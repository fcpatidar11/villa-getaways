...
if( $destination_id ) {
    ...
    $villas = searchVillas($conn, $_REQUEST['destination_id'], $location_ids, $region_ids, date("d/m/Y", strtotime($date_start)), date("d/m/Y", strtotime($date_end)), $bedrooms, $page, $price);
        ...
        <div class="card-column">
            <div class="card-column__block">
                ...
                <div class="card-content">
                    ...
                    if(isset($villa['AVAILABILITY']) && $villa['AVAILABILITY']==0){ ?>
                     <p class="rate icon-calender"><span class="glyphicon glyphicon-calendar"></span>Unavailable for Chosen Date</p>    
                    <?php }else{    
                    ...
                    if ($villa["PRICE"] > 0) {
                        ...
                        ?>
                            ...
                            <?php if(isset($_REQUEST['date_start']) && isset($_REQUEST['date_end'])) {?>
